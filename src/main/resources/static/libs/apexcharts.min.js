            ...
            value: function() {
                ...
                for (var n = e.globals.legendFormatter, o = e.config.legend.inverseOrder, l = o ? a.length - 1 : 0; o ? l >= 0 : l <= a.length - 1; o ? l-- : l++) {
                    ...
                    if (!e.config.legend.showForZeroSeries)
                        0 === z.getSeriesTotalByIndex(l) && z.seriesHaveSameValues(l) && !z.isSeriesNull(l) && -1 === e.globals.collapsedSeriesIndices.indexOf(l) && -1 === e.globals.ancillaryCollapsedSeriesIndices.indexOf(l) && L.classList.add("apexcharts-hidden-zero-series");
                ...
                e.config.legend.onItemHover.highlightDataSeries && (e.globals.dom.elWrap.addEventListener("mousemove", t.onLegendHovered, !0),
            ...
            value: function(t) {
                ...
                for (var x = function(t, r) {
                    ...
                    if (c.globals.axisCharts) {
                        ...
                        e = m(b)) : (h && h.target && h.target.getAttribute("fill") && (p = h.target.getAttribute("fill")),
                        e = m(a))
                    }
                ...
                }, b = 0, m = c.globals.series.length - 1; b < c.globals.series.length; b++,
                m--)
                    x(b, m)
            }
        }, {
        ...
        return a(t, [{
            ...
            value: function(t) {
                for (var e = this.w, i = this, a = this.ttCtx, s = t, r = e.globals.dom.baseEl.querySelectorAll(".apexcharts-series:not(.apexcharts-series-collapsed) .apexcharts-marker"), n = e.config.markers.hover.size, o = 0; o < r.length; o++) {
                    ...
                    if (void 0 === n && (n = e.globals.markers.size[h] + e.config.markers.hover.sizeOffset),
                    s === parseInt(l, 10)) {
            ...
            value: function(t, e) {
                ...
                for (var n = a.group({
                    ...
                    for (var k = a.group({
                        ...
                        var S, C = this.barHelpers.getStrokeWidth(o, A, p), P = this.drawCandleStickPaths({
                            indexes: {
                                i: o,
                                j: A,
                                realIndex: p
    ...
    window.TreemapSquared.generate = function() {
        function t(e, i, a, s) {
            ...
            this.getCoordinates = function(t) {
                ...
                if (this.width >= this.height)
                    for (e = 0; e < t.length; e++)
                        i.push([a, s, a + n, s + t[e] / n]),
                        s += t[e] / n;
                else
                    for (e = 0; e < t.length; e++)
                        i.push([a, s, a + t[e] / o, s + o]),
                        a += t[e] / o;
                return i
            }
            ,
        ...
        function i(t, e, s, n) {
            ...
            if (0 !== t.length)
                ...
                i(t.slice(1), e, s, n)) : (h = s.cutArea(r(e), n),
                ...
                if (s.comboCharts) {
                    ...
                    case "bar":
                        if (a.chart.stacked)
                            ...
                            p = new X(this.ctx,e).draw(s.series);
                        break;
                    case "candlestick":
        ...
        function a(t) {
            ...
            case "A":
                t = (e = function(t, e) {
                    ...
                    (a = i.x * i.x / (T * T) + i.y * i.y / (z * z)) > 1 && (T *= a = Math.sqrt(a),
                    z *= a);
